...
if (comments_open() || pings_open()) {
	...
	comment_form(
		array(
			...
			'title_reply_before' => '',
			'title_reply_after'  => '',
			'submit_button'        => '<button type="submit" class="btn btn-primary fs-4">share</button>',
                ...
                <!--- Post Form Begins -->
                    <div class="card-header fs-3">
                        <ul class="nav nav-tabs card-header-tabs" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="posts-tab" data-toggle="tab" href="#posts" role="tab" aria-controls="posts" aria-selected="true">' . __('Make a Post', 'twentytwenty') . '</a>
                            </li>
                        </ul>
                    </div>
                    <div class="card-body">
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="posts" role="tabpanel" aria-labelledby="posts-tab">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control fs-4" id="message" name="comment" rows="3" placeholder="' . esc_attr__('What are you thinking...', 'twentytwenty') . '" required></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
